...
private:
	...
	float m_cameraAngle;	    //The camera angle being used
	float m_cameraDistance;     //The distance of the camera from the origin
	float m_spinRate;           //The rate for the camera to spin at
	float m_cameraHeight;       //The height of the camera
